...
\begin{itemize}
  ...
  \item La mayoría de esos métodos utilizan heurísticas que buscan optimizaciones locales fusionando o separando clusters, pudiendo resultar en un resultado inexacto global.
\end{itemize}
