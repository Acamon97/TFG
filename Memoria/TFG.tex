...
\subsection{Medidas de distancia} \label{subsec:Medidas de distancia}
...
\caption{Clusterización jerárquica algomerativa (AGNES) y divisiva (DIANA) sobre el conjunto de datos \{$a$,$b$,$c$,$d$,$e$\} \cite{16}.}
\end{figure}
...
La característica que permite a BIRCH esto es utilizar un concepto denominado \textit{}
